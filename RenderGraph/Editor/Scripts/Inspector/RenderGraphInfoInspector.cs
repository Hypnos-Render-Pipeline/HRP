...
namespace HypnosRenderPipeline.RenderGraph
{
    ...
    public class RenderGraphInfoInspector : Editor
    {
        ...
        {
            //base.OnInspectorGUI();
            var info = target as RenderGraphInfo;
            ...
            {
                EditorGUILayout.LabelField("View transform");
                var rect = EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("(" + info.viewPosition.x + ",   " + info.viewPosition.y + ",   " + info.viewScale.x + ")");
                EditorGUILayout.EndHorizontal();
                EditorGUI.DrawRect(rect, new Color(0f, 0f, 0f, 0.1f));
            }
        }
