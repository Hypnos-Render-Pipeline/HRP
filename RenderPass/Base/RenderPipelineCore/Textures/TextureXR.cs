...
namespace HypnosRenderPipeline.RenderGraph
{
    ...
    /// </summary>
    public static class FTextureXR
    {
        ...
        static FRTHandle m_BlackUIntTexture2DArrayRTH;
        static FRTHandle m_BlackUIntTextureRTH;
        /// <summary>
        /// Default black unsigned integer texture.
        /// </summary>
        /// <returns>The default black unsigned integer texture.</returns>
        public static FRTHandle GetBlackUIntTexture() { return useTexArray ? m_BlackUIntTexture2DArrayRTH : m_BlackUIntTextureRTH; }

        static Texture2DArray   m_ClearTexture2DArray;
        static Texture2D        m_ClearTexture;
        static FRTHandle m_ClearTexture2DArrayRTH;
        static FRTHandle m_ClearTextureRTH;
        /// <summary>
        /// Default clear color (0, 0, 0, 1) texture.
        /// </summary>
        /// <returns>The default clear color texture.</returns>
        public static FRTHandle GetClearTexture() { return useTexArray ? m_ClearTexture2DArrayRTH : m_ClearTextureRTH; }

        static Texture2DArray   m_MagentaTexture2DArray;
        static Texture2D        m_MagentaTexture;
        static FRTHandle m_MagentaTexture2DArrayRTH;
        static FRTHandle m_MagentaTextureRTH;
        /// <summary>
        /// Default magenta texture.
        /// </summary>
        /// <returns>The default magenta texture.</returns>
        public static FRTHandle GetMagentaTexture() { return useTexArray ? m_MagentaTexture2DArrayRTH : m_MagentaTextureRTH; }

        static Texture3D        m_BlackTexture3D;
        static Texture2DArray   m_BlackTexture2DArray;
        static FRTHandle m_BlackTexture2DArrayRTH;
        static FRTHandle m_BlackTextureRTH;
        static FRTHandle m_BlackTexture3DRTH;
        /// <summary>
        /// Default black texture.
        /// </summary>
        /// <returns>The default black texture.</returns>
        public static FRTHandle GetBlackTexture() { return useTexArray ? m_BlackTexture2DArrayRTH : m_BlackTextureRTH; }
        /// <summary>
        /// Default black texture array.
        /// </summary>
        /// <returns>The default black texture array.</returns>
        public static FRTHandle GetBlackTextureArray() { return m_BlackTexture2DArrayRTH; }
        /// <summary>
        /// Default black texture 3D.
        /// </summary>
        /// <returns>The default black texture 3D.</returns>
        public static FRTHandle GetBlackTexture3D() { return m_BlackTexture3DRTH; }

        static Texture2DArray   m_WhiteTexture2DArray;
        static FRTHandle m_WhiteTexture2DArrayRTH;
        static FRTHandle m_WhiteTextureRTH;
        /// <summary>
        /// Default white texture.
        /// </summary>
        /// <returns>The default white texture.</returns>
        public static FRTHandle GetWhiteTexture() { return useTexArray ? m_WhiteTexture2DArrayRTH : m_WhiteTextureRTH; }
        ...
        public static void Initialize(CommandBuffer cmd, ComputeShader clearR32_UIntShader)
        {
            ...
            {
                // Black UINT
                FRTHandles.Release(m_BlackUIntTexture2DArrayRTH);
                m_BlackUIntTexture2DArray = CreateBlackUIntTextureArray(cmd, clearR32_UIntShader);
                m_BlackUIntTexture2DArrayRTH = FRTHandles.Alloc(m_BlackUIntTexture2DArray);
                FRTHandles.Release(m_BlackUIntTextureRTH);
                m_BlackUIntTexture = CreateBlackUintTexture(cmd, clearR32_UIntShader);
                m_BlackUIntTextureRTH = FRTHandles.Alloc(m_BlackUIntTexture);

                // Clear
                FRTHandles.Release(m_ClearTextureRTH);
                ...
                m_ClearTextureRTH = FRTHandles.Alloc(m_ClearTexture);
                FRTHandles.Release(m_ClearTexture2DArrayRTH);
                m_ClearTexture2DArray = CreateTexture2DArrayFromTexture2D(m_ClearTexture, "Clear Texture2DArray");
                m_ClearTexture2DArrayRTH = FRTHandles.Alloc(m_ClearTexture2DArray);

                // Magenta
                FRTHandles.Release(m_MagentaTextureRTH);
                ...
                m_MagentaTextureRTH = FRTHandles.Alloc(m_MagentaTexture);
                FRTHandles.Release(m_MagentaTexture2DArrayRTH);
                m_MagentaTexture2DArray = CreateTexture2DArrayFromTexture2D(m_MagentaTexture, "Magenta Texture2DArray");
                m_MagentaTexture2DArrayRTH = FRTHandles.Alloc(m_MagentaTexture2DArray);

                // Black
                FRTHandles.Release(m_BlackTextureRTH);
                m_BlackTextureRTH = FRTHandles.Alloc(Texture2D.blackTexture);
                FRTHandles.Release(m_BlackTexture2DArrayRTH);
                m_BlackTexture2DArray = CreateTexture2DArrayFromTexture2D(Texture2D.blackTexture, "Black Texture2DArray");
                m_BlackTexture2DArrayRTH = FRTHandles.Alloc(m_BlackTexture2DArray);
                FRTHandles.Release(m_BlackTexture3DRTH);
                m_BlackTexture3D = CreateBlackTexture3D("Black Texture3D");
                m_BlackTexture3DRTH = FRTHandles.Alloc(m_BlackTexture3D);

                // White
                FRTHandles.Release(m_WhiteTextureRTH);
                m_WhiteTextureRTH = FRTHandles.Alloc(Texture2D.whiteTexture);
                FRTHandles.Release(m_WhiteTexture2DArrayRTH);
                m_WhiteTexture2DArray = CreateTexture2DArrayFromTexture2D(Texture2D.whiteTexture, "White Texture2DArray");
                m_WhiteTexture2DArrayRTH = FRTHandles.Alloc(m_WhiteTexture2DArray);
            }
        }
