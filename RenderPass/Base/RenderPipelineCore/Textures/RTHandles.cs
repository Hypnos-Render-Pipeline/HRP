...
namespace HypnosRenderPipeline.RenderGraph
{
    ...
    /// </summary>
    public static class FRTHandles
    {
        static FRTHandleSystem s_DefaultInstance = new FRTHandleSystem();
        ...
        /// </summary>
        public static FRTHandleProperties rtHandleProperties { get { return s_DefaultInstance.rtHandleProperties; } }
        ...
        public static FRTHandle Alloc(Texture tex)
        {
        ...
        /// <param name="tex">Input texture</param>
        /// <returns>A new RTHandle referencing the input texture.</returns>
        public static FRTHandle Alloc(RenderTexture tex)
        {
            return s_DefaultInstance.Alloc(tex);
        }
        ...
        public static FRTHandle Alloc(RenderTargetIdentifier tex)
        {
            return s_DefaultInstance.Alloc(tex);
        }
        ...
        public static void Initialize(
            ...
            EMSAASamples scaledRTMSAASamples
            )
        {
        ...
        public static void Release(FRTHandle rth)
        {
