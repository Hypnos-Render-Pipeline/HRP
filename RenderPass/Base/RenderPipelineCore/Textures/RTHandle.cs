...
namespace HypnosRenderPipeline.RenderGraph
{
    ...
    /// </summary>
    public class FRTHandle
    {
        internal FRTHandleSystem m_Owner;
        ...
        /// </summary>
        public FRTHandleProperties rtHandleProperties { get { return m_Owner.rtHandleProperties; } }
        /// <summary>
        ...
        internal FRTHandle(FRTHandleSystem owner)
        {
            m_Owner = owner;
        }
        ...
        public static implicit operator RenderTexture(FRTHandle handle)
        {
        ...
        public static implicit operator Texture(FRTHandle handle)
        {
        ...
        public static implicit operator RenderTargetIdentifier(FRTHandle handle)
        {
